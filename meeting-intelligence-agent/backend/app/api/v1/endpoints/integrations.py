...
This module still owns the route handlers, but request schemas now live in
...
from app.api.v1.endpoints.integrations_schemas import (
    AutoSyncPlatformRequest,
    BotJoinRequest,
    CapturePolicyEvaluateRequest,
    CapturePolicyRequest,
    GoogleConnectRequest,
    GoogleOAuthCodeRequest,
    LinearConnectRequest,
    LiveTranscriptSegmentRequest,
    LiveTranscriptionStartRequest,
    MeetingConsentOptOutRequest,
